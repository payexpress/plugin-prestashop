...
class Payexpresse extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->name = 'payexpresse';
        $this->tab = 'payments_gateways';
        $this->version = '1.0.0';
        $this->author = 'PaxExpresse';
        $this->display = 'view';
        ...
        $this->displayName = $this->l('PayExpresse');
        ...
        $this->express_checkout = $this->l('Payexpress Express Checkout ');
    ...
    public function install()
    {
        ...
        if (!Configuration::updateValue('PE_SECRET_KEY', '')
            ...
            || !Configuration::updateValue('PE_URL_PAYMENT_REQUEST', 'https://payexpresse.com/api/payment/request-payment')
            || !Configuration::updateValue('PE_URL_REDIRECT', 'https://preview.payexpresse.com/payment/checkout/')
            || !Configuration::updateValue('PE_URL_SUCCESS',  Context::getContext()->link->getModuleLink('payexpresse', 'paiementvalidation',array('success'=>1)))
            || !Configuration::updateValue('PE_URL_CANCEL',  Context::getContext()->link->getModuleLink('payexpresse', 'paiementvalidation',array('cancel'=>1)))
            || !Configuration::updateValue('PE_URL_IPN',  Context::getContext()->link->getModuleLink('payexpresse', 'ipnpaiementconfirmation'))
    ...
    public function hookPaymentOptions($params)
    {
          ...
          $checkout = Context::getContext()->link->getModuleLink('payexpresse', 'paiement');
          $paymentOption->setAction($checkout);
          $paymentOption->setModuleName($this->name);
          $paymentOption->setCallToActionText("Paiement Par PayExpresse");
    ...
    public function hookDisplayPaymentReturn($params)
    {
        ...
        return $this->fetch('module:payexpresse/views/templates/hook/payment_return.tpl');
    }
